...
const LatestNews = () => {
  ...
  <img src="https://images.pexels.com/photos/33702229/pexels-photo-33702229.jpeg" className="card-img-top" alt="news-image"/>
  ...
  <div className="row g-0">
    <div className="col-md-4">
      <img src="https://www.hul.co.in/content-images/92ui5egz/production/03bdbfc3d0d979e4e9fcb230fed7905fa3a9e8c0-1920x1080.jpg?rect=2,0,1917,1080&w=600&h=338&fit=crop&auto=format" className="img-fluid rounded-start" alt=""/>
    </div>
